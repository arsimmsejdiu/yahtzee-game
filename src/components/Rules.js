...
const ones = new TotalOneNumber({ val: 1, description: "1 piont for 1" });
const twos = new TotalOneNumber({ val: 2, description: "2 piont for 2" });
const threes = new TotalOneNumber({ val: 3, description: "3 piont for 3" });
const fours = new TotalOneNumber({ val: 4, description: "4 piont for 4" });
const fives = new TotalOneNumber({ val: 5, description: "5 piont for 5" });
const sixes = new TotalOneNumber({ val: 6, description: "6 piont for 6" });
...
const fullHouse = new FullHouse({
  score: 25,
  description: "25 point fo a full house",
});
